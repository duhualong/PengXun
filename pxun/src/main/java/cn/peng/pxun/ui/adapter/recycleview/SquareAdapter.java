...
public class SquareAdapter extends BaseQuickAdapter<Posts, BaseViewHolder> {

    public SquareAdapter(int layoutResId, @Nullable List<Posts> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, Posts item) {
