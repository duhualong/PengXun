...
public class BigPicActivity extends BaseActivity {
    ...
    protected void initListener() {
        mPvBigpic.setOnTapListener(new DragPhotoView.OnTapListener() {
            @Override
            public void onTap(DragPhotoView dragPhotoView) {
                finishWithAnimation();
            }
        });
        mPvBigpic.setOnExitListener(new DragPhotoView.OnExitListener() {
            @Override
        ...
        mPvBigpic.getViewTreeObserver()
                .addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        ...
                        mPvBigpic.getLocationOnScreen(location);

                        mTargetHeight = (float) mPvBigpic.getHeight();
                        mTargetWidth = (float) mPvBigpic.getWidth();
                        ...
                        mPvBigpic.setTranslationX(mTranslationX);
                        mPvBigpic.setTranslationY(mTranslationY);

                        mPvBigpic.setScaleX(mScaleX);
                        mPvBigpic.setScaleY(mScaleY);

                        performEnterAnimation();

                        mPvBigpic.setMinScale(mScaleX);
    ...
    private void performEnterAnimation() {
        ValueAnimator translateXAnimator = ValueAnimator.ofFloat(mPvBigpic.getX(), 0);
        translateXAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                mPvBigpic.setX((Float) valueAnimator.getAnimatedValue());
            }
        });
        translateXAnimator.setDuration(300);
        translateXAnimator.start();

        ValueAnimator translateYAnimator = ValueAnimator.ofFloat(mPvBigpic.getY(), 0);
        translateYAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                mPvBigpic.setY((Float) valueAnimator.getAnimatedValue());
            }
        });
        ...
        scaleYAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                mPvBigpic.setScaleY((Float) valueAnimator.getAnimatedValue());
            }
        });
        ...
        scaleXAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                mPvBigpic.setScaleX((Float) valueAnimator.getAnimatedValue());
            }
        });
    ...
    private void finishWithAnimation() {
        final DragPhotoView photoView = mPvBigpic;
